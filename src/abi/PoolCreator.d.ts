...
export class PoolCreator extends Contract {
  ...
  functions: {
    ...
    getSHUBToken(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
  ...
  getSHUBToken(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    getSHUBToken(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getSHUBToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
